...
export function getCountryCode(name) { return fromName[name.toUpperCase()]; }
...
export function getCountryName(code) { return fromCode[code.toUpperCase()]; }
...
export function getAllCodes() { return Object.keys(fromCode).slice(1).sort(); }
